      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4 sticky top-24">
            <div className="bg-neutral-950 border border-white/5 p-6 rounded-2xl space-y-6">
              ...
              <div className="border border-sky-500/20 bg-sky-500/5 p-4 rounded-xl space-y-4">
                ...
                <p className="text-[11px] text-neutral-400 leading-normal">
                  Split this payment into 3 equal monthly bites, interest-free.
                  Your tailored collection layout looks exactly like this:
                </p>
